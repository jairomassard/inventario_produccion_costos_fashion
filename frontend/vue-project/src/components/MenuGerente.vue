<template>
  <div class="menu-principal">
    ...
    <div class="menu-grid">
      ...
      <router-link class="menu-button" to="/produccion-admin" v-if="tipoUsuario === 'admin' || tipoUsuario === 'gerente'">Gestión de Producción</router-link>
      <router-link class="menu-button" to="/reportes-produccion" v-if="tipoUsuario === 'admin' || tipoUsuario === 'gerente'">Reportes de Producción</router-link>
    </div>
