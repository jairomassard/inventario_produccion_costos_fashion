<template>
      ...
      <section class="carga-csv">
        ...
        <div class="carga-input">
            ...
            <button @click="limpiarSesionCsv" class="btn-warning">Limpiar Sesión</button>
        </div>
        ...
        <div v-if="mostrarModal" class="modal-instructivo">
            <div class="modal-contenido">
                ...
                <p>6️⃣ **Cantidad Productos**: Si el producto es Base, se coloca 0. Si es compuesto, indicar cuántos productos lo conforman.</p>
                <p>7️⃣ **Código y Cantidad de Productos Base**: Se deben indicar los códigos y cantidades de los productos base.</p>
  ...
  export default {
    ...
    data() {
      return {
        producto: { id: null, codigo: '', nombre: '', es_producto_compuesto: false },
        productos: [],
        materiales: [],
    ...
    methods: {
      ...
      descargarPlantillaCSV() {
        ...
        const csvContent = 
            ...
            `codigo,nombre,peso_total_gr,peso_unidad_gr,codigo_barras,es_producto_compuesto,cantidad_productos,codigo1,cantidad1,codigo2,cantidad2\n` +
            `GRA12345678901234,Ejemplo Producto Base,500,50,1234567890123,No,0,,,,\n` +
            `GRA98765432109876,Ejemplo Producto Compuesto,,,9876543210987,Si,2,GRA12345678901234,2,GRA12199905000000,3\n`;
